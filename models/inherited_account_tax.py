...
class ProductProduct(models.Model):
    ...
    @api.model
    def _get_tax_included_unit_price_cus(self, company, currency, document_date, document_type,
            is_refund_document=False, product_uom=None, product_currency=None,
            product_price_unit=None, product_taxes=None, fiscal_position=None, order_id=None,
        ):
        ...
        if currency != product_currency:
            if order_id:
                product_price_unit = product_price_unit * order_id.manual_currency_exchange_rate
            # else:
